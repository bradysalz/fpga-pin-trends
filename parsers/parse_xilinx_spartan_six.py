...
def parse_xilinx_spartan_six(filepath: Path, config: Dict) -> List[Pin]:
...
if __name__ == '__main__':
    with open('data/xilinx/spartan_six/overview.toml', 'r') as f:
        config = toml.load(f)

    x = parse_xilinx_spartan_six(
        Path('data/xilinx/spartan_six/6slx100tfgg484pkg.txt'),
        config,
    )
