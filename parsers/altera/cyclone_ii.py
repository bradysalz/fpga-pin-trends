...
def parse_altera_cyclone_ii(filepath: Path, config: Dict) -> List[Pin]:
    """Parse Altera Cyclone II pinout to a Pin list.
...
if __name__ == '__main__':
    with open('data/altera/cyclone2/overview.toml', 'r') as f:
        config = toml.load(f)

    x = parse_altera_cyclone_ii(
        Path('data/altera/cyclone2/ep2c20_ep2c15a_ep2c20a.txt'),
        config,
    )
